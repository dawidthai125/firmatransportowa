...
export const APP_FEATURES: AppFeature[] = [
  ...
  {
    id: 'admin-weekly-planner',
    title: 'Plan tygodnia',
    description: 'Widok 7 dni — kto, gdzie i kiedy. Kursy widoczne w dniach między załadunkiem a rozładunkiem.',
    area: 'admin',
    roles: ['owner', 'dispatcher'],
    status: 'live',
    adminView: 'weeklyPlanner',
    module: 'weeklyPlanner',
    dataKeys: ['courses'],
    codePaths: ['src/app/views/WeeklyPlannerView.tsx'],
    sinceVersion: '0.18',
  },
  {
    id: 'admin-invoicing',
    title: 'Integracja fakturowania',
    description: 'Eksport dostarczonych kursów do CSV, Fakturownia lub wFirma. Moduł włączany w Ustawieniach firmy.',
    area: 'admin',
    roles: ['owner'],
    status: 'beta',
    adminView: 'invoicing',
    module: 'invoicing',
    dataKeys: ['courses', 'invoicing-config'],
    codePaths: ['src/app/views/InvoicingView.tsx', 'src/lib/domain/invoice-export.ts'],
    sinceVersion: '0.18',
  },
  {
    id: 'admin-driver-payroll',
    title: 'Wynagrodzenia kierowców',
    description: 'Stawki km / dzień / % frachtu — zestawienie wypłat z raportów kabiny za wybrany okres.',
    area: 'admin',
    roles: ['owner'],
    status: 'live',
    adminView: 'driverPayroll',
    module: 'driverPayroll',
    dataKeys: ['driver-payroll-rates', 'daily-reports', 'courses'],
    codePaths: ['src/app/views/DriverPayrollView.tsx'],
    sinceVersion: '0.18',
  },
  {
    id: 'admin-vehicle-margin',
    title: 'Marża per pojazd',
    description: 'Tabela fracht vs koszty planowane i z raportów — panel na pulpicie właściciela.',
    area: 'admin',
    roles: ['owner', 'dispatcher'],
    status: 'live',
    adminView: 'dashboard',
    module: 'vehicleMargin',
    codePaths: ['src/app/components/dashboard/VehicleMarginPanel.tsx'],
    sinceVersion: '0.18',
  },
  {
    id: 'admin-client-portal',
    title: 'Portal klienta (tracking)',
    description: 'Link read-only #track/TOKEN — status kursu bez logowania. Włącz per kurs w module Kursy.',
    area: 'admin',
    roles: ['owner', 'dispatcher'],
    status: 'live',
    module: 'clientPortal',
    codePaths: ['src/app/views/ClientTrackingView.tsx'],
    sinceVersion: '0.18',
  },
  {
    id: 'driver-course-status',
    title: 'Statusy kursu z kabiny',
    description: 'Kierowca: Załadowany → W trasie → Dostarczony. Alert na pulpicie dyspozytora w 24 h.',
    area: 'driver',
    roles: ['driver'],
    status: 'live',
    driverView: 'courses',
    module: 'courseStatusPing',
    dataKeys: ['courses'],
    codePaths: ['src/app/components/course/CourseStatusActions.tsx'],
    sinceVersion: '0.18',
  },
  {
    id: 'driver-course-documents',
    title: 'Zdjęcia CMR / POD',
    description: 'Upload zdjęć listu przewozowego i potwierdzenia dostawy z telefonu przy kursie.',
    area: 'driver',
    roles: ['driver', 'owner', 'dispatcher'],
    status: 'live',
    driverView: 'courses',
    module: 'courseDocuments',
    dataKeys: ['courses'],
    codePaths: ['src/app/components/course/CourseDocumentsPanel.tsx'],
    sinceVersion: '0.18',
  },
  {
    id: 'course-driver-chat',
    title: 'Czat przy kursie',
    description: 'Wiadomości tekstowe dyspozytor ↔ kierowca — synchronizacja przez chmurę.',
    area: 'admin',
